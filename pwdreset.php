	...
	?>
			...
			<form action="include/reset-request.inc.php" method="POST">
              <div class="form-outline mb-4">
                <input type="text" id="typeEmailX-2" name='email' class="form-control form-control-lg" />
                <label class="form-label" for="typeEmailX-2">E-mail</label>
              </div>
 
              <button class="btn btn-primary btn-lg btn-block" type="submit" name="reset-request-submit">Recive new password by E-mail</button>
